...
<!-- Start of Header -->
 ...
 <li class="dropdown "> <a class="dropdown-toggle" href="#.html" > GESTION DES PETITIONS<b class="caret"></b> </a>
						<ul class="dropdown-menu">
												<li><a href="affiche_don1.php">ajouter petitions</a></li>
	...
	<section class="container-fluid container">
		<section class="row-fluid">
				...
				<section class="span9" id="blog_listing">
					...
					<div class="inner_lyr">
				<form action="modif_don.php" method="post">
					<table width="45%" height="255" border="0" align="left">
           
            <tr>
              <td>Nom *</td>
              <td><input type="text" maxlength="38" name="nom" value="<?php echo $_GET['nom']?>" /></td>
            </tr>
            <tr>
              <td><label >prenom *</span></label></td>
              <td><input type="text" maxlength="38" name="prenom"   value="<?php echo $_GET['prenom']?>"/></td>
            </tr>
            ...
            <tr>
              <td >email:</td>
              <td><input type="text" name="email" id="textfield" value="<?php echo $_GET['email']?>"/></td>
            </tr>
            <tr>
              <td >type membre:</td>
              <td><input type="text" name="type" id="textfield" value="<?php echo $_GET['type']?>"/></td>
            </tr>
            <tr>
              <td >montant:</td>
              <td><input type="text" name="montant" id="textfield" value="<?php echo $_GET['mont']?>"/></td>
            </tr>
            <tr>
              <td >mode paiment:</td>
              <td><input type="text" name="modep" id="textfield" value="<?php echo $_GET['modp']?>"/></td>
            </tr>
          </table>
          <br />
          <input type="submit" />
			...
			?>
	          <tr>
	            ...
	            <td><a href="modifier_don1.php?email=<?php echo $ligne[3]?>&nom=<?php echo $ligne[1]?>&prenom=<?php echo$ligne[2]?>&email=<?php echo$ligne[3]?>&type=<?php echo$ligne[4]?>&mont=<?php echo$ligne[5]?>&modp=<?php echo$ligne[6]?>" >modifier</a></td>
	            </tr>
	          <?php
			}
			?>
