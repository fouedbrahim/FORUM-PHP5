				...
				<div class="navbar-inner">
				  ...
				  <div class="nav-collapse collapse">
					<ul class="nav">
   					 ...
   					 <li class="dropdown Active"> <a class="dropdown-toggle" href="#.html" > GESTION DES INFORMATIONS <b class="caret"></b> </a>
						<ul class="dropdown-menu">
						
						<li><a href="affiche_info.php">afficher les infos</a></li>
                        <li><a href="index.html">ajouter des infos</a></li>
		...
		<section class="row-fluid">
				...
				<section class="span9" id="blog_listing">
					...
					<div class="inner_lyr">
						...
						<br><br>
	<form name="a" method="post" action="ajout.php">
    <table border="1">
			<tr>
			...
			<tr>
					...
					<td>
						<a href="delete.php?Id_cl=<?php echo $ligne[0]?>">Delete information</a>
						</td>
					<td>
					
<a href="update.php?Question=<?php echo $ligne[0]?>&Nom=<?php echo $ligne[1]?>&Courriel=<?php echo $ligne[2] ?>&Numero=<?php echo $ligne[3] ?>&Code=<?php echo $ligne[4] ?>">Update information </a>
									</td>
				</tr>
			<?php
			}
