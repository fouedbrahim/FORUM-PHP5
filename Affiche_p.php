...
<!-- Start of Header -->
 ...
 <li class="dropdown "> <a class="dropdown-toggle" href="#.html" > GESTION DES PETITIONS<b class="caret"></b> </a>
						...
						<li class="dropdown"> <a href="inscription.html"> inscription </a> </li>
...
<section class="mtop">
	...
	<table border="1">
			...
			<tr>
					...
					<td>
						<a href="delete_p.php?nom=<?php echo $ligne[0]?>">Delete personne</a>
						</td>
					<td>
					
<a href="update_p.php?Id_cl=<?php echo $ligne[0]?>&nom=<?php echo $ligne[1]?>&email=<?php echo $ligne[3] ?>&age=<?php echo $ligne[2] ?>&date=<?php echo $ligne[4] ?>&sexe=<?php echo $ligne[5] ?>">Update personne </a>
									</td>
