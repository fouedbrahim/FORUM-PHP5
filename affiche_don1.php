...
<!-- Start of Header -->
  ...
  <li class="dropdown "> <a class="dropdown-toggle" href="#.html" > GESTION DES DONS <b class="caret"></b> </a>
					...
					<li class="dropdown Active"> <a class="dropdown-toggle" href="#.html" > GESTION DES INFORMATIONS <b class="caret"></b> </a> <ul class="dropdown-menu"> <li><a href="affiche_info.php">afficher les infos</a></li> <li><a href="ajout_info.php">ajouter des infos</a></li> </ul> </li>	
